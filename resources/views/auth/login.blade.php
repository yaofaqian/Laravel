...
<style>
    ...
    body{ background: url("{{ asset('images/body.jpg') }}")}
    .loginWraper{
        margin:17% auto;
    }
</style>
		...
		<form class="form form-horizontal" action="/login" method="post">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-3">
					<input id="email" name="email" type="email" placeholder="账户" class="input-text size-L" >
			...
			<div class="row cl">
				<label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
				<div class="formControls col-xs-3">
					<input id="" name="" type="password" placeholder="密码" class="input-text size-L" required>
				</div>
			</div>
			<div class="row cl">
			...
			<div class="row cl">
				<div class="formControls col-xs-8 col-xs-offset-3">
					<label for="online">
						<input type="checkbox" name="remember" id="online" value="">
						使我保持登录状态</label>
				</div>
			</div>
			<div class="row cl">
